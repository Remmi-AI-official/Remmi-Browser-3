 ...
 * Provides encrypted export with Argon2id + AES-256-GCM + HMAC-SHA256 tamper verification.
 */
object PasswordBackupManager {
  ...
  fun importEncryptedBackup(
    ...
    if (!root.optBoolean("remmi_vault_backup", false)) {
    ...
    try {
      ...
      val version = payloadJson.optInt("version", 1)
