...
object NetworkHardening {
  ...
  fun getHardenedPrivacyPreferences(settings: com.remmi.browser.storage.BrowserSettings? = null): Map<String, Any> {
    // RFP master toggle drives the whole resistFingerprinting family so the
    // "RFP" settings switch is not a dummy.
    ...
    return mapOf(
      ...
      "privacy.resistFingerprinting" to (settings?.antiFingerprintingRFP ?: true),
