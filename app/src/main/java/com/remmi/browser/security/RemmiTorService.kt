...
class RemmiTorService : TorService() {
  ...
  override fun onTaskRemoved(rootIntent: Intent?) {
    // Keep Tor foreground service running across activity and task switching
    DebugLogManager.log("RemmiTorService onTaskRemoved: Task removed, preserving Tor foreground service")
  }
  ...
  companion object {
    ...
    @Volatile
    var currentInstance: RemmiTorService? = null
      private set
